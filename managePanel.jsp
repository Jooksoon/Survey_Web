	...
	<div class="main">
		...
		<div class="searchbar"">
			<form class="searchbar-form">
				<fieldset>
					...
					</select> <input type="search" id="query" name="q" placeholder="회원조회"
		...
		<div class="surveynav">
			<form class="surveynav-form">
	           ...
	           %>
				<span id="prev"><a
					href="mnm.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>"
					class="prev-span" style="text-decoration: none;">&lt;</a></span>
				<%
	               }
	               for (i = ((cPage * totalRecords) - (totalRecords - 1)); i <= (cPage * totalRecords); i++) {
	                   if (i == ((iPageNo / showRows) + 1)) {%>
				<span class="numbers"><a href="mnm.jsp?iPageNo=<%=i%>"
					class="number-span1" style="text-decoration: none;"><%=i%></a></span>
				<%
	               } else if (i <= totalPages) {
	               %>
				<span class="numbers"><a href="mnm.jsp?iPageNo=<%=i%>"
					class="number-span2" style="text-decoration: none;"><%=i%></a></span>
				<%
	                       }
	                   }
	               ...
	               %>
				<span id="next"><a
					href="mnm.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>" class="next-span"
